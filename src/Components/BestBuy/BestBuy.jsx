...
const BestBuy = () => {
    const bestData = useLoaderData();
    const [bestBuyDetails, setBestBuyDetails] = useState([])
    useEffect(() => {
        const bestBuys = bestData.filter(bestBuy => bestBuy?.brandName == 'BestBuy');
        setBestBuyDetails(bestBuys)
    }, [bestData])
    console.log(bestBuyDetails)
    return (
        <div className="max-w-screen-xl mx-auto px-5 lg:px-0">
            <div>
                <h2 className="text-center text-5xl font-bold my-7">BestBuy Product</h2>
                <div className="carousel w-full h-[540px]">
                    <div id="slide1" className="carousel-item relative w-full">
                        <img src="https://i.ibb.co/cYZBXzK/best-buy-secrets-hero-flickr-jeepersmedia.webp" className="w-full" />
                    ...
                    <div id="slide2" className="carousel-item relative w-full">
                        <img src="https://i.ibb.co/5k0dk3Z/1660770703237.jpg" className="w-full" />
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    ...
                    <div id="slide3" className="carousel-item relative w-full">
                        <img src="https://i.ibb.co/rvw49ck/store-Best-Buy-1200x630px.webp" className="w-full" />
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                            <a href="#slide2" className="btn btn-circle">❮</a>
                            <a href="#slide1" className="btn btn-circle">❯</a>
                        </div>
            ...
            {
                bestBuyDetails.length ? <div className="grid lg:grid-cols-2 gap-5 my-10">
                {
                    bestBuyDetails.map(detail => <div className="grid grid-cols-1 md:grid-cols-3 gap-3 shadow-2xl bg-accent rounded-lg py-5 md:py-0" key={detail._id}>
