...
const Walmart = () => {
    ...
    const [walmartDetails, setWalmartDetails] = useState([])
    useEffect(() => {
        const amazons = amazonData.filter(amazon => amazon?.brandName == 'Walmart');
        setWalmartDetails(amazons)
    }, [amazonData])
    return (
        <div className="max-w-screen-xl mx-auto px-5 lg:px-0">
            <div>
                <h2 className="text-center text-5xl font-bold my-7">Walmart Product</h2>
                <div className="carousel w-full h-[540px]">
                    <div id="slide1" className="carousel-item relative w-full">
                        <img src="https://i.ibb.co/T4cjd8c/screen-shot-2019-11-14-at-103155-am.png" className="w-full" />
                    ...
                    <div id="slide2" className="carousel-item relative w-full">
                        <img src="https://i.ibb.co/ySLZ2Mf/Walmart1-1024x538.webp" className="w-full" />
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    ...
                    <div id="slide3" className="carousel-item relative w-full">
                        <img src="https://i.ibb.co/4NTfDN9/Walmart-Black-Friday-Ad-Featured-1121.jpg" className="w-full" />
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                            <a href="#slide2" className="btn btn-circle">❮</a>
                            <a href="#slide1" className="btn btn-circle">❯</a>
                        </div>
            ...
            {
                walmartDetails.length ? <div className="grid lg:grid-cols-2 gap-5 my-10">
                {
                    walmartDetails.map(detail => <div className="grid grid-cols-1 md:grid-cols-3 gap-3 shadow-2xl bg-accent rounded-lg py-5 md:py-0" key={detail._id}>
